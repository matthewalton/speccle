...
([ADR-0037](adr/0037-a-slice-src-may-nest-into-purpose-named-subfolders.md)). Keep
...
The slice's agent-facing entry point ([ADR-0049](adr/0049-a-slices-agent-file-is-claude-md-and-carries-only-what-that-slice-needs.md)),
...
([ADR-0040](adr/0040-speccle-reads-repo-facts-from-a-dot-speccle-folder.md)).
